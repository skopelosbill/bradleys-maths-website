const problemBank =[
    ...
    // 12 March
    {
        ...
        "major_area": "Algebra",
        "topic": "Exponential Growth & Decay",
        "subtopic": "Exponential Growth & Decay",
        "difficulty": "A/A*",
    ...
    // 28 March (NEW - Simultaneous Equations)
    {
        "id": "003087",
        "date": "28 March 2026",
        "major_area": "Algebra",
        ...
        "difficulty": "B",
        "q": "A cinema sells adult tickets and child tickets.<br>3 adult tickets and 4 child tickets cost £43.<br>2 adult tickets and 3 child tickets cost £30.<br>Calculate the cost of one adult ticket and the cost of one child ticket.",
        "steps":[
            "We begin by defining our variables: let $a$ be the cost of an adult ticket and $c$ be the cost of a child ticket.",
            "We can write two equations: $3a + 4c = 43$ and $2a + 3c = 30$.",
            "To eliminate $a$, we multiply the first equation by 2 and the second equation by 3.",
            "This gives: $6a + 8c = 86$ and $6a + 9c = 90$.",
            "Subtracting the first equation from the second eliminates the $a$ terms: $(6a - 6a) + (9c - 8c) = 90 - 86$.",
            "This directly gives $c = 4$. So, a child ticket costs £4.",
            "Substitute $c = 4$ back into the first original equation: $3a + 4(4) = 43 \\implies 3a + 16 = 43$.",
        ...
        "bradley_insight": {
            ...
            "content": "When a problem is given in words, don't automatically jump to using $x$ and $y$. Using $a$ for adult and $c$ for child helps prevent the incredibly common mistake of finding the correct numbers but assigning them to the wrong ticket type at the end of the question!"
        },
        "payhip_link": "https://payhip.com/b/mg5YS",
        "button_text": "Master IGCSE Algebra: Download the Extended Pack"
    },
// 29 March (Compound Shapes)
    {
        "id": "003088",
        "date": "29 March 2026",
        ...
        "difficulty": "B/A",
        "img": "true",
        "q": "The diagram shows a large circle of radius $3\\text{ cm}$. Inside it are 7 smaller circles, each of radius $1\\text{ cm}$. The central small circle is concentric with the large circle. The 6 outer small circles are tangent to the central circle, the large circle, and their neighbouring small circles.<br>Calculate the exact area of the shaded region. Give your answer in terms of $\\pi$.",
        "steps":[
            "To find the shaded area, we must subtract the area of the 7 unshaded small circles from the area of the large outer circle.",
            "First, calculate the total area of the large outer circle: $\\text{Area} = \\pi r^2 = \\pi \\times 3^2 = 9\\pi$.",
            "Next, calculate the area of one unshaded small circle: $\\text{Area} = \\pi \\times 1^2 = \\pi$.",
            "Since there are $1 + 6 = 7$ small circles in total, the total unshaded area is $7 \\times \\pi = 7\\pi$.",
        ...
        "bradley_insight": {
            ...
            "content": "Whenever a question asks for the 'exact area' or an answer 'in terms of $\\pi$', do not convert $\\pi$ to a decimal. Treat $\\pi$ exactly like an algebraic variable (e.g., $9x - 7x = 2x$). This not only saves calculation time but completely avoids any risk of rounding errors."
        },
        "payhip_link": "https://payhip.com/b/KjXoP",
        "button_text": "Master IGCSE Mensuration and Trigonometry: Download the Extended Pack"
    },
    ...
    // 31 March (NEW - Stem and Leaf Diagram)
    {
        "id": "003090",
        "date": "31 March 2026",
        ...
        "difficulty": "B/C",
        "q": "The table shows the scores of 30 students in a maths test.<br><br><table style='width: 100%; text-align: center;'><tr><td>23</td><td>14</td><td>45</td><td>32</td><td>28</td><td>19</td><td>37</td><td>41</td><td>25</td><td>33</td></tr><tr><td>12</td><td>38</td><td>44</td><td>29</td><td>21</td><td>35</td><td>18</td><td>42</td><td>27</td><td>31</td></tr><tr><td>24</td><td>15</td><td>39</td><td>46</td><td>22</td><td>36</td><td>17</td><td>40</td><td>26</td><td>30</td></tr></table><br>(a) Construct an ordered stem and leaf diagram to represent this data.<br>(b) Find the median score.<br>(c) Calculate the interquartile range (IQR).",
        "steps":[
            "For part (a), we group the data by their tens digits (1, 2, 3, 4) and order the units. (Check the model answer image to verify your diagram is correct!).",
            "For part (b), there are 30 values. The median position is $(30 + 1) \\div 2 = 15.5$. We must average the 15th and 16th values.",
            "Counting from the top of the ordered diagram, the 15th value is 29 and the 16th value is 30. Median $= (29 + 30) \\div 2 = 29.5$.",
            "For part (c), the Lower Quartile (LQ) is the $\\dfrac{30+1}{4} = 7.75th$ value, which we find between the 7th and 8th items (21 and 22), so $LQ = 21.5$.",
            "The Upper Quartile (UQ) is the $3 \\times 7.75 = 23.25th$ value, which we find between the 23rd and 24th items (38 and 39), so $UQ = 38.5$.",
        ...
        "bradley_insight": {
            ...
            "content": "A Stem and Leaf diagram is entirely worthless without a 'Key'. Even if every number is ordered perfectly, Cambridge examiners will withhold marks if you fail to explicitly state what the numbers mean (e.g., Key: 1 | 2 means 12). Also, ensure your 'leaves' line up perfectly vertically so the diagram visually acts like a bar chart."
        },
        "payhip_link": "https://payhip.com/b/rsVCz",
        "button_text": "Master IGCSE Transformations, Vectors, Probability, and Statistics: Download the Extended Pack"
    }
